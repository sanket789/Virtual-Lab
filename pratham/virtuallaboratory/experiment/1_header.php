...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
     ...
     <li><a href="/pratham/virtuallaboratory/index.php">Home</a></li>
		<li><a href="/pratham/virtuallaboratory/experiment/1_aim.php">Aim & Theory</a></li>

		<li><a href="/pratham/virtuallaboratory/experiment/1_procedure.php">Procedure</a>
        <!--<ul>
  		...
  		<li><a href="/pratham/virtuallaboratory/experiment/1_simulation.php">Simulation</a>
        </li>
        <li><a href="/pratham/virtuallaboratory/experiment/1_resources.php">Resources</a>
       	</li>
</ul>
<br style="clear: left" />
</div></td>
