<?php
    ...
    include("zipfile.php");
    include("util.php");
	$fhandle0 = fopen("xf0.txt", 'w') or die("can't open file");
	$fhandle1 = fopen("xf1.txt", 'w') or die("can't open file");
	$fhandle2 = fopen("xf2.txt", 'w') or die("can't open file");
	$fhandle3 = fopen("xf3.txt", 'w') or die("can't open file");
	$fhandle4 = fopen("xf4.txt", 'w') or die("can't open file");
	$fhandle5 = fopen("xf5.txt", 'w') or die("can't open file");
	$fhandle00 = fopen("xf00.txt", 'w') or die("can't open file");
	$fhandle11 = fopen("xf11.txt", 'w') or die("can't open file");
	$fhandle22 = fopen("xf22.txt", 'w') or die("can't open file");
	$fhandle33 = fopen("xf33.txt", 'w') or die("can't open file");
	$fhandle44 = fopen("xf44.txt", 'w') or die("can't open file");
	$fhandle55 = fopen("xf55.txt", 'w') or die("can't open file");
	$fhandleinput1 = fopen("input1.txt", 'w') or die("can't open file");
	$fhandlerad = fopen("radius.txt", 'w') or die ("can't open file");
//	fwrite($fh, $stringData);
	...
	$tempomax =  "RADIUS_UNSCALED = ".$radius."; ANGLE =".$angle."; TYPE = 1;";
	fwrite($fhandlerad, $tempomax);
    ...
    $f_pol .= "Radius from centre of earth, " . $radius . "\n";
    $f_pol .= "Inclination, " . $degrees . "\n";
    $f_pol .= "Time period, " . $time_period. "\n";
    ...
    for ($i = 0; $i < 1000; $i++) {
        ...
        $t1 = $shadow * sin($omega_t) * $cos_d * SOLAR_FLUX;
        $t2 = (-$t1);
        $t3 = $shadow * cos($omega_t) * $cos_d * SOLAR_FLUX;
        $t4 = (-$t3);
