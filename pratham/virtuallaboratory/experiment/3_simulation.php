...
<script type="text/javascript" >
	...
	function prop(){
    	...
    	var q = .00000005670367*F12*Y*X*[(Math.pow(T1,4))-(Math.pow(T2,4))];
...
<p style="text-align:justify;" class="Textz">Satellite PRATHAM has a cuboidal structure. The side panels of the satellite continuously emit radiant heat energy to each other as well as to the surrounding space, here we have to deal with transient as well as steady state analysis. The above problem is only one small example of steady state or equilibrium situation. </p>
