...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
      ...
      <li><a href="/pratham/virtuallaboratory/index.php">Home</a></li>
		<li><a href="/pratham/virtuallaboratory/experiment/4_aim.php">Aim & Theory</a></li>
  		<li><a href="/pratham/virtuallaboratory/experiment/4_simulation.php">Simulation</a>
        </li>
        <li><a href="/pratham/virtuallaboratory/experiment/4_resources.php">Resources</a>
       	</li>
</ul>
<br style="clear: left" />
</div></td>
